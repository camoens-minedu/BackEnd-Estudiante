...
-- ===============================================================================================================
-------------------------------------------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[USP_EVALUACION_INS_CARGA_MASIVA_ACTAS_ANT]
(	
...
BEGIN TRY
	...
	Begin --> DECLARACION DE VARIABLES 
		...
		--*************************************
		--*************************************
		DECLARE @ID_CARGA_MASIVA_ACTAS_CABECERA INT;			
		...
		--********************************************
		DECLARE @VALIDACION_UD_1 VARCHAR(400);
		DECLARE @VALIDACION_UD_2 VARCHAR(400);
		DECLARE @VALIDACION_UD_3 VARCHAR(400);
		DECLARE @VALIDACION_UD_4 VARCHAR(400);
		DECLARE @VALIDACION_UD_5 VARCHAR(400);
		DECLARE @VALIDACION_UD_6 VARCHAR(400);
		DECLARE @VALIDACION_UD_7 VARCHAR(400);
		DECLARE @VALIDACION_UD_8 VARCHAR(400);
		DECLARE @VALIDACION_UD_9 VARCHAR(400);
		DECLARE @VALIDACION_UD_10 VARCHAR(400);
		DECLARE @VALIDACION_UD_11 VARCHAR(400);
		DECLARE @VALIDACION_UD_12 VARCHAR(400);
		DECLARE @VALIDACION_UD_13 VARCHAR(400);
		DECLARE @VALIDACION_UD_14 VARCHAR(400);
		DECLARE @VALIDACION_UD_15 VARCHAR(400);
		DECLARE @VALIDACION_UD_16 VARCHAR(400);
		DECLARE @VALIDACION_UD_17 VARCHAR(400);
		DECLARE @VALIDACION_UD_18 VARCHAR(400);
		DECLARE @VALIDACION_UD_19 VARCHAR(400);
		DECLARE @VALIDACION_UD_20 VARCHAR(400);
		--********************************************
		DECLARE @DNI VARCHAR(400);
		DECLARE @NOMBRE_ALUMNO VARCHAR(400);
		DECLARE @VALIDA_NOTA_UD INT = 0;	--SI ES 0 = CORRECTO / 1 = ERRORES
		DECLARE @ALUMNOS_ERROR	NVARCHAR(MAX) = '';
	End	

	Begin --> DECLARACION DE VARIABLES DE TABLA 
		DECLARE @Carga_masiva_actas_cabecera_tmp TABLE (ID_CARGA_MASIVA_ACTAS_CABECERA INT)
		--DECLARE @Carga_masiva_nominas_cabecera_tmp TABLE (ID_CARGA_MASIVA_ACTAS_CABECERA INT)
	End
	...
	IF EXISTS (SELECT TOP 1 ID_CARGA_MASIVA_ACTAS_CABECERA FROM transaccional.carga_masiva_actas_cabecera 
	...
	End
				...
				Begin --> WHILE VALIDACION ALUMNOS 
		...
		BEGIN
		   SET @CONT = @CONT + 1	   
			...
			Begin --> VALIDACION	--@PERIODO_LECTIVO
		
				Begin --> OBTENER NOTAS DEL ALUMNO	
					...
					SELECT						
						...
						@UNIDAD_DIDACTICA_19 = Z,
						@UNIDAD_DIDACTICA_20 = AA
					FROM #tmp WHERE rowIndex > 17 AND A = @CONT;
	
				End

				Begin --> OBTENER CURSOS DEL ALUMNO MATRICULADO 
			
					SELECT 
						 @VALIDACION_UD_1 = cnd.UNIDAD_DIDACTICA_1
						,@VALIDACION_UD_2 = cnd.UNIDAD_DIDACTICA_2
						,@VALIDACION_UD_3 = cnd.UNIDAD_DIDACTICA_3
						,@VALIDACION_UD_4 = cnd.UNIDAD_DIDACTICA_4
						,@VALIDACION_UD_5 = cnd.UNIDAD_DIDACTICA_5
						,@VALIDACION_UD_6 = cnd.UNIDAD_DIDACTICA_6
						,@VALIDACION_UD_7 = cnd.UNIDAD_DIDACTICA_7
						,@VALIDACION_UD_8 = cnd.UNIDAD_DIDACTICA_8
						,@VALIDACION_UD_9 = cnd.UNIDAD_DIDACTICA_9
						,@VALIDACION_UD_10 = cnd.UNIDAD_DIDACTICA_10
						,@VALIDACION_UD_11 = cnd.UNIDAD_DIDACTICA_11
						,@VALIDACION_UD_12 = cnd.UNIDAD_DIDACTICA_12
						,@VALIDACION_UD_13 = cnd.UNIDAD_DIDACTICA_13
						,@VALIDACION_UD_14 = cnd.UNIDAD_DIDACTICA_14
						,@VALIDACION_UD_15 = cnd.UNIDAD_DIDACTICA_15
						,@VALIDACION_UD_16 = cnd.UNIDAD_DIDACTICA_16
						,@VALIDACION_UD_17 = cnd.UNIDAD_DIDACTICA_17
						,@VALIDACION_UD_18 = cnd.UNIDAD_DIDACTICA_18
						,@VALIDACION_UD_19 = cnd.UNIDAD_DIDACTICA_19
						,@VALIDACION_UD_20 = cnd.UNIDAD_DIDACTICA_20
					FROM transaccional.carga_masiva_nominas_cabecera cn
						INNER JOIN transaccional.carga_masiva_nominas_cabecera_detalle cnd ON cn.ID_CARGA_MASIVA_NOMINAS_CABECERA = cnd.ID_CARGA_MASIVA_NOMINAS_CABECERA
					WHERE 1 = 1
						AND cn.PERIODO_LECTIVO = @PERIODO_LECTIVO
						AND cnd.NUMERO_DOCUMENTO_IDENTIDAD = @DNI
				End

				Begin --> VALIDAR CURSO Y NOTA 
					
					SET @VALIDA_NOTA_UD = 0;					

					IF @UNIDAD_DIDACTICA_1	<> '' AND @VALIDACION_UD_1  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END					
					IF @UNIDAD_DIDACTICA_2	<> '' AND @VALIDACION_UD_2  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_3	<> '' AND @VALIDACION_UD_3  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_4	<> '' AND @VALIDACION_UD_4  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_5	<> '' AND @VALIDACION_UD_5  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_6	<> '' AND @VALIDACION_UD_6  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_7	<> '' AND @VALIDACION_UD_7  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_8	<> '' AND @VALIDACION_UD_8  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_9	<> '' AND @VALIDACION_UD_9  = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_10 <> '' AND @VALIDACION_UD_10 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_11 <> '' AND @VALIDACION_UD_11 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_12 <> '' AND @VALIDACION_UD_12 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_13 <> '' AND @VALIDACION_UD_13 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_14 <> '' AND @VALIDACION_UD_14 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_15 <> '' AND @VALIDACION_UD_15 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_16 <> '' AND @VALIDACION_UD_16 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_17 <> '' AND @VALIDACION_UD_17 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_18 <> '' AND @VALIDACION_UD_18 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_19 <> '' AND @VALIDACION_UD_19 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					IF @UNIDAD_DIDACTICA_20 <> '' AND @VALIDACION_UD_20 = '' BEGIN SET @VALIDA_NOTA_UD = 1; END
					
					-------
					IF @VALIDA_NOTA_UD = 1
					BEGIN						
						SET @ALUMNOS_ERROR = @ALUMNOS_ERROR + @NOMBRE_ALUMNO + ', ';				
					END
	...
	--*******************************************************************************************************************************************************************************************************************	
		...
		BEGIN 
			...
			Begin --> INSERTAR CABECERA 
				...
				INSERT INTO transaccional.carga_masiva_actas_cabecera 
				(									
					CARRERA,
					PERIODO_ACADEMICO,
					CICLO,
				...
				OUTPUT INSERTED.ID_CARGA_MASIVA_ACTAS_CABECERA INTO @Carga_masiva_actas_cabecera_tmp(ID_CARGA_MASIVA_ACTAS_CABECERA)
			...
			Begin --> REGISTRAR ID NUEVO REGISTRO 
				SET @ID_CARGA_MASIVA_ACTAS_CABECERA = (SELECT ID_CARGA_MASIVA_ACTAS_CABECERA as 'ID_CARGA_MASIVA_ACTAS_CABECERA recien registrado' FROM @Carga_masiva_actas_cabecera_tmp);		
			End

			Begin --> INSERTAR DETALLES 
				INSERT INTO transaccional.carga_masiva_actas_cabecera_detalle
				SELECT
					@ID_CARGA_MASIVA_ACTAS_CABECERA,
					A,B,C,E,F,G,			
	...
	Begin --> RESPUESTA FINAL 
		...
		BEGIN
			...
			ELSE
				BEGIN				
					SET @RESPUETA_MENSAJE = 'No se ha podido registrar porque los alumnos. - ' + @ALUMNOS_ERROR + ' contienen errores.'
					SELECT 
						EstadoProceso = '2'
						,Mensajes = @RESPUETA_MENSAJE
				END

...
LLAMADO POR			:
DESCRIPCION			:	Elimina el registro de evaluacion extraordinaria.
REVISIONES			:
-----------------------------------------------------------------------------------------------------------
...
**********************************************************************************************************/
CREATE PROCEDURE [dbo].[USP_TRANSACCIONAL_DEL_EVALUACION_EXTRAORDINARIA]
(
	@ID_INSTITUCION					        INT, 
...
SET NOCOUNT ON;
	...
	BEGIN
		...
		WHERE 
			[ID_EVALUACION_EXTRAORDINARIA] = @ID_EVALUACION_EXTRAORDINARIA

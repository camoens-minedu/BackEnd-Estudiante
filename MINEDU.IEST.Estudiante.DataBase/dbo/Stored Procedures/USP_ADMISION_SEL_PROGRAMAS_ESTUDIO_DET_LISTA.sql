--USP_ADMISION_SEL_PROGRAMAS_ESTUDIO_DET_LISTA 443,209,895
CREATE PROCEDURE [dbo].[USP_ADMISION_SEL_PROGRAMAS_ESTUDIO_DET_LISTA]
(	
	@ID_INSTITUCION INT, 
...
FROM db_auxiliar.dbo.UVW_CARRERA C
	...
	LEFT JOIN (
		...
		INNER JOIN transaccional.resoluciones_por_periodo_lectivo_institucion RXPLI ON RXPLI.ID_RESOLUCION = RXCI.ID_RESOLUCION AND RXPLI.ES_ACTIVO=1
		INNER JOIN transaccional.periodos_lectivos_por_institucion PLI ON PLI.ID_PERIODOS_LECTIVOS_POR_INSTITUCION = RXPLI.ID_PERIODOS_LECTIVOS_POR_INSTITUCION AND PLI.ES_ACTIVO=1
...
WHERE SUB_CONSULTA_RESOLUCIONES.ID_RESOLUCION IS NULL

...
--  DESCRIPCION:	INSERTA EN EL FORMATO DESCARGADO EXCEL DE CARGA MASIVA MATRICULA LA UNIDAD DIDACTICA

--  TEST:			EXEC USP_MATRICULA_CARGA_MASIVA_UNIDAD_DIDACTICA 7,101,112

-- ===============================================================================================================
-------------------------------------------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[USP_MATRICULA_CARGA_MASIVA_UNIDAD_DIDACTICA]
(
	@ID_CARRERA						INT,

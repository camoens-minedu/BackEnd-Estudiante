...
1.1			24/03/2021		JCHAVEZ			MODIFICACION PARA MOSTRAR ID_TIPO_PLAN_ESTUDIOS
1.2			07/02/2022		JCHAVEZ			MODIFICACIÓN DEL CAMPO NombrePlanEstudios PARA AGREGAR NOMBRE DEL TIPO DE PLAN

TEST:		USP_MATRICULA_SEL_MATRICULA_ESTUDIANTE_PAGINADO 290, 3921,0,'','',0,0,0,0,0,0,0
			USP_MATRICULA_SEL_MATRICULA_ESTUDIANTE_PAGINADO 2164,1666,0,'','',0,0,0,0,0,0,0
*************************************************************************************************************************************/
CREATE PROCEDURE [dbo].[USP_MATRICULA_SEL_MATRICULA_ESTUDIANTE_PAGINADO]
(  
	@ID_INSTITUCION					INT,

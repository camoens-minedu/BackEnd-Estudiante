...
--  DESCRIPCION:	FUNCION QUE OBTIENE LA RUTA DE LA DESCARGA DE FORMATO PARA CARGA MASIVA MATRICULA

--  TEST:			SELECT dbo.UFN_RUTA_ARCHIVO_CARGA_MASIVA_MATRICULA(0)

-- ===============================================================================================================
-------------------------------------------------------------------------------------------------------------------
CREATE FUNCTION [dbo].[UFN_RUTA_ARCHIVO_CARGA_MASIVA_MATRICULA] 
(
	@valorOpcion INT	
)
RETURNS varchar(100)
...
BEGIN		
	...
	--//DECLARACION DE VARIABLES
		...
		DECLARE @NOMBRE_CARPETA_COPIA_ARCHIVO_PARA_PROCESAR		VARCHAR(100) = 'DATA_CARGA_MATRICULA'
		...
		BEGIN
			...
			BEGIN
				SET @RUTA = @RUTA_BASE + @NOMBRE_CARPETA_DESCARGA_PLANTILLAS + '\CargaMasivaMatricula.xlsm'				
			END
		END

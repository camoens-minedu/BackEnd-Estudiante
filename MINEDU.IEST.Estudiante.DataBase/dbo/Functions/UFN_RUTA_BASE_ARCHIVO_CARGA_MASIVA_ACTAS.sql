...
--  TEST:			SELECT dbo.UFN_RUTA_BASE_ARCHIVO_CARGA_MASIVA_ACTAS()

-- ===============================================================================================================
-------------------------------------------------------------------------------------------------------------------
CREATE FUNCTION [dbo].[UFN_RUTA_BASE_ARCHIVO_CARGA_MASIVA_ACTAS] 
(
	--@IdItinerario INT
	--,@IdModalidad INT
	--,@IdEnfoque INT
...
BEGIN		
		...
		--//RUTA ARCHIVO
		BEGIN			
				SET @RUTA_ARCHIVO = @RUTA_BASE + 'DATA_CARGA_MASIVA_NOMINA\PlantillaCargaActas.xlsx'				
		END

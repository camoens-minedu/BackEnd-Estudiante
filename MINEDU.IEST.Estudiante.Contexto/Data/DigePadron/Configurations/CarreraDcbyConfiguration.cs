...
{
    public partial class CarreraDcbyConfiguration : IEntityTypeConfiguration<CarreraDcby>
    {
        public void Configure(EntityTypeBuilder<CarreraDcby> entity)
        {
            entity.HasKey(e => e.IdCarreraDcbIes)
                .HasName("PK_CARRERA_DCB_IES");

            entity.ToTable("carrera_dcb_ies");

            entity.Property(e => e.IdCarreraDcbIes)
                .ValueGeneratedNever()
                .HasColumnName("ID_CARRERA_DCB_IES");

            entity.Property(e => e.CodigoCarreraDcbIes)
                .HasMaxLength(14)
                .HasColumnName("CODIGO_CARRERA_DCB_IES");
            ...
            entity.Property(e => e.NombreCarreraDcbIes)
                .HasMaxLength(500)
                .HasColumnName("NOMBRE_CARRERA_DCB_IES");
            ...
            entity.HasOne(d => d.IdNivelEstudioNavigation)
                .WithMany(p => p.CarreraDcbies)
                .HasForeignKey(d => d.IdNivelEstudio)
                .HasConstraintName("FK_CARRERA__REFERENCE_TIPO_NIV_IES");

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<CarreraDcby> entity);
    }
}

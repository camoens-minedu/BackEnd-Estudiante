...
{
    public partial class TipoExpedienteConfiguration : IEntityTypeConfiguration<TipoExpediente>
    {
        public void Configure(EntityTypeBuilder<TipoExpediente> entity)
        {
            entity.HasKey(e => e.IdTipoExpediente);

            entity.ToTable("tipo_expediente");

            entity.Property(e => e.IdTipoExpediente)
                .ValueGeneratedNever()
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<TipoExpediente> entity);
    }
}
